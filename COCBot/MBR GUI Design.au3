...
Global $g_hFrmBot_MAIN_PIC = 0, $g_hFrmBot_URL_PIC = 0, $g_hFrmBot_URL_PIC2 = 0, $g_hFrmBot_lbl_Mod = 0, $g_hFrmBot_lbl_Mod1 = 0
...
Func CreateMainGUIControls($bGuiModeUpdate = False)
	...
	If Not $bGuiModeUpdate Then
		...
		$g_hFrmBot_lbl_Mod = GUICtrlCreateLabel("xbebenkMod_" & $g_sXModversion & " ", $_GUI_MAIN_WIDTH - 180, 15, 180 , 20 ,$SS_RIGHT)
		GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
		GUICtrlSetColor(-1, $COLOR_INFO)
		GUICtrlSetFont (-1,9, 800)
		GUICtrlSetState($g_hFrmBot_MAIN_PIC, $GUI_ENABLE)
		$g_hFrmBot_lbl_Mod1 = GUICtrlCreateLabel("xdebenkMod_" & $g_sXModversion1 & " ", 5, 20, 135 , 20 ,$SS_LEFT)
		GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
		GUICtrlSetColor(-1, $COLOR_INFO)
		GUICtrlSetFont (-1,9, 800)
		GUICtrlSetState($g_hFrmBot_MAIN_PIC, $GUI_ENABLE)
